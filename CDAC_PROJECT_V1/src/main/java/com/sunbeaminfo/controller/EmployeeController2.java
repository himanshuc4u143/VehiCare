...
//	private EmployeeService empService;
	...
	@PostMapping
	public Courses SaveCourseDetails(@RequestBody Courses c)
	{
		
		return cs.AddCourseDetails(c);
	}
	...
	{
		return ResponseEntity.ok(cs.ListOfCoursesByCategory(category));
	}
...
//
//		return new ResponseEntity<>(empService.authenticateEmp(request), HttpStatus.OK);
//
//	}
//
...
//	}
//
//	// add a method list all emp names drawing sal > min sal
//	// Req : http://host:port/employees/salary/{minSal} , method=GET
//	@GetMapping("/salary/{minSal}")
//	public ResponseEntity<?> listEmpNamesBySalary(@PathVariable double minSal) {
//		System.out.println("in list emp names " + minSal);
//		return ResponseEntity.ok(empService.getEmpNamesBySalarySanket(minSal));
//	}
